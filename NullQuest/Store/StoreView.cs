...
{
    public class StoreView : View<StoreView, StoreViewModel>
    {
        ...
        private readonly StatsView<StoreView, StoreViewModel> statsView;
        ...
        public StoreView()
        {
            ...
            statsView = new StatsView<StoreView, StoreViewModel>(
