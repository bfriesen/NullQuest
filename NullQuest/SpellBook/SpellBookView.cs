...
{
    public class SpellBookView : View<SpellBookView, SpellBookViewModel>
    {
        ...
        private readonly StatsView<SpellBookView, SpellBookViewModel> statsView;
        ...
        public SpellBookView()
        {
            ...
            statsView = new StatsView<SpellBookView, SpellBookViewModel>(
